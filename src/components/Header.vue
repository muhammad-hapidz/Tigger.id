  ...
  >
    <div class="flex items-center">
      ...
      <div class="relative mx-4 lg:mx-0">
        ...
        <input
          class=" p-2 border w-32 pl-10 pr-4 text-indigo-600 border-gray-200 rounded-md sm:w-64 focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
          type="text"
          placeholder="Search"
        >
      </div>
