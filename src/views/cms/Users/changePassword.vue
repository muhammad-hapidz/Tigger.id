...
const changePassword = async () => {
  ...
  try {
    ...
    if (!payload.oldPassword || !payload.password || !payload.confirmPassword) {
...
<template>
  <div class="mt-6 p-4 bg-white shadow rounded-lg">
    <h3 class="text-3xl font-semibold text-gray-700 text-center underline">Change Password</h3>
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
          ...
          <div class="grid grid-cols-1 gap-6 mt-4">
            ...
            <div class="relative">
              ...
              >
                <svg
                  v-if="showPasswords.oldPassword"
